        ...
        <Row className="">
          <Col lg={8} xl={7} className="align-items-start">
            <Row>
              ...
              <Col lg={2} xl={2} className="set-col">
                <Link to="/branch/customer" className="link">
                  <div className="dash-icon" type="button">
                    <img src="icon/member.png" className="icon" />
                    <p className="p-1">Customer(B2C)</p>
                  </div>
                </Link>
                <Link to="/branch/package" className="link">
                  <div className="dash-icon" type="button">
              ...
              {/* <Col lg={2} xl={2} className="set-col">
                <Link to="/branch/service" className="link">
                  <div className="dash-icon" type="button">
              ...
              <Col lg={2} xl={2} className="set-col">
                <Link to="/branch/job" className="link">
                  <div className="dash-icon" type="button">
                    <img src="icon/job.png" className="icon" />
                    <p className="p-1">Job</p>
                  </div>
                </Link>
                <Link to="/branch/bill" className="link">
                  <div className="dash-icon" type="button">
                    <img src="icon/job.png" className="icon" />
                ...
                <Link to="/branch/report" className="link">
                  <div className="dash-icon" type="button">
