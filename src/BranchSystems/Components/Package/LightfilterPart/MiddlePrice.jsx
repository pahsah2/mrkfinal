    ...
    <>
      <Container fluid className="set-heght">
        <Form>
            ...
            <Row className="g-0">
              ...
              <Col>
                <Row>
                  ...
                  >
                    <p>กำหนดเช็คการเซ็ตตัว</p>
                  </Col>
                  <Col xs={7} md={8} lg={3} xl={3}>
                    <Form.Control
                      type="text"
                      placeholder=""
                      // defaultValue={statepage[0]}
          ...
          <p className="form-title">ตั้งราคา</p>
          <Form.Group className="package-data " controlId="formBasicEmail">
            <Row>
              <Col lg={3}>
                <Row>
          ...
          >
            <table className="table table-responsive table-wash-part ">
              ...
              <tbody className="t-body-package ">
                <tr>
                  <td>Ceramic Ultta Clear Series</td>
                  <td>CM IR 5</td>
                  <td>5500</td>
                  <td>6000</td>
                  <td>6500</td>
