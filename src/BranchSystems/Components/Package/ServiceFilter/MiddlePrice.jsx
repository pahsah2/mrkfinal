...
export default function MiddlePrice() {
  ...
  const [returnWork, setReturnWork] = useState('');
  const [insurance, setInsurance] = useState('');
  const [count, setCount] = useState('');
  // ขนาดรถและราคา
  const [series, setSeries] = useState('');
  const [number_series, setNumber_series] = useState('');
  ...
  const [claim_price, setClaim_price] = useState('');
    ...
    <>
      <Container fluid className="set-heght">
        <Form>
                ...
                <Row>
                  ...
                  <Col xs={5} md={8} lg={5} xl={3}>
                    <Form.Control
                      ...
                      // defaultValue={statepage[0]}
                      value={returnWork}
                      onChange={(e) => setReturnWork(e.target.value)}
                      className="input-middle-price"
                    ></Form.Control>
                  </Col>
                  <Col
                ...
                <Row>
                  <Col xs={9} md={9} lg={6}>
                    <Form.Control
                      ...
                      // defaultValue={statepage[0]}
                      value={claim_price}
                      onChange={(e) => setClaim_price(e.target.value)}
                      className="input-middle-price"
                    ></Form.Control>
                  </Col>
                  <Col className="text-title">
                ...
                <Row>
                  ...
                  <Col>
                    <Form.Control
                      ...
                      // defaultValue={statepage[0]}
                      value={number_series}
                      onChange={(e) => setNumber_series(e.target.value)}
                      className="input-search-add-wash-part"
                    ></Form.Control>
                  </Col>
                </Row>
          ...
          <p className="form-title">ตารางราคา</p>
          <Row className="g-0" style={{ overflow: 'scroll', height: '280px' }}>
            <table className="table table-responsive table-wash-part ">
              <thead>
                <tr className="t-header-package">
                  <th style={{ width: '20%', textAlign: 'left' }}>รุ่น</th>
                  <th>เลขรุ่น</th>
                  <th>S</th>
                  <th>M</th>
                  <th>L</th>
              ...
              <tbody className="t-body-package ">
                <tr>
                  <td style={{ textAlign: 'left' }}>Crytalline Series</td>
                  <td>CR20</td>
                  <td>5500</td>
                  <td>6000</td>
                  <td>6500</td>
        ...
        <Row className="g-0" style={{ overflow: 'scroll', height: '200px' }}>
          <table className="table table-responsive table-wash-part ">
            ...
            <tbody className="t-body-package ">
              <tr>
                <td style={{ textAlign: 'left' }}>น้ำยา WAX</td>
                <td>0.5</td>
                <td>0.5</td>
                <td>1</td>
                <td>1</td>
