...
import MiddlePrice_SpecialPackage from '../Components/Package/SpecialPackage/MiddlePrice';
import AddSpecialPackageComponent from '../Components/Package/SpecialPackage/AddSpecialPackage';
                  ...
                  <Col>
                    ...
                    >
                      <Tab eventKey="MiddlePrice_WashPart" title="ราคากลาง">
                        <MiddlePrice_SpecialPackage />
                      </Tab>
                      <Tab eventKey="AddWashPartComponent" title="ราคา B2B">
                        <AddSpecialPackageComponent />
                      </Tab>
                    </Tabs>
                  </Col>
                </Row>
